...
de: {
  ...
  setupleiste: {
    ...
    kennzahlen: [{ zahl: "15", text: "Live-Werte in der Leiste" }, { zahl: "11", text: "Bestwerte mit Hoch und Tief" }, { zahl: "6", text: "Zeitraum-Spalten je Bestwert" }, { zahl: "3", text: "Groessenstufen der Leiste" }],
    ablaufTitel: "So fängst du an",
    ablaufSchritte: [
      { nr: "1", titel: "Installieren", text: "Ein Installer-Programm fuehrt durch die Einrichtung — auf Wunsch mit Desktop-Symbol und automatischem Start beim Anmelden." },
      ...
      { nr: "3", titel: "Anzeigen auswaehlen", text: "Ueber das Zahnrad laesst sich jeder einzelne Wert an- und abschalten, dazu die Groesse der Leiste in drei Stufen einstellen." },
      { nr: "4", titel: "Bestwerte ansehen", text: "Der Pokal-Knopf oeffnet die Bestwerte-Liste: Hoechst- und Tiefstwerte je Messwert, aufgefaechert ueber sechs Spalten." },
      ...
      { nr: "6", titel: "Einklappen oder verschieben", text: "Der Pfeil klappt die Leiste zu einem schmalen Streifen ein, ein erneuter Klick wieder aus. Mit der Maus laesst sich die Leiste an eine andere Stelle ziehen." },
    ],
    kniffTitel: "Ein Programm ohne Beiwerk",
    kniffText: "Die Leiste ist reines C++ mit den Bordmitteln von Windows gebaut — kein Framework, keine Fremdbibliothek, kein nachzuinstallierendes Laufzeitpaket. Die fertige Datei laeuft einfach. Jeder Messwert wird in einem eigenen Hintergrund-Strang geholt, damit die Leiste selbst nie stockt, auch wenn eine Abfrage gerade haengt.",
    koennenTitel: "Was drinsteckt",
    koennenListe: [
      { name: "📊  Fuenfzehn Live-Werte", text: "Ping, Internet-Datenfluss, FPS, Arbeitsspeicher, Prozessor-Auslastung und -Watt, Grafikkarten-Auslastung, Takt, Grafikspeicher und Watt, Temperatur, Akku, Stromverbrauch, Laufzeit und Aufloesung — alle in einer Zeile." },
      { name: "🏆  Elf Bestwerte", text: "Zu elf Messwerten fuehrt das Programm dauerhaft Hoechst- und Tiefstwert: Temperaturen, Leistungen, Ping, gemessene Leitung ueber WLAN und Kabel, Datenmengen und Laufzeit." },
      { name: "📅  Sechs Zeitraeume nebeneinander", text: "Jeder Bestwert steht in sechs Spalten: Heute, Woche, Monat, Jahr, Moeglich und Gesamt. Tag bis Jahr beginnen jeweils neu, Gesamt laeuft durch — so sieht man den heutigen Spitzenwert und den Rekord aller Zeiten im selben Blick." },
      { name: "🔍  Drei Groessenstufen", text: "Die Leiste laesst sich in Klein, Mittel oder Gross schalten — auf hochaufloesenden Bildschirmen ist die kleine Stufe sonst kaum lesbar." },
      { name: "⚙️  Jede Anzeige einzeln schaltbar", text: "Im Zahnrad-Menue laesst sich jeder Wert einzeln ein- und ausblenden, dazu alle auf einmal an oder aus. Die Leiste wird dabei automatisch schmaler oder breiter." },
      { name: "🚀  Leitung wirklich messen", text: "Ein Knopf startet eine echte Downloadmessung ueber eine weltweit gut angebundene Gegenstelle. Das Ergebnis wird getrennt nach WLAN und Netzwerkkabel als Bestwert gefuehrt." },
      { name: "⚡  Stromzaehler ueber fuenf Zeitraeume", text: "Die Leistung von Grafikkarte und Prozessor wird laufend zu Kilowattstunden aufsummiert — fuer Tag, Woche, Monat, Jahr und gesamt." },
      { name: "🔋  Akku mit Ladebalken", text: "Ladestand als farbiger Balken, dazu die Restkapazitaet. Auf einem Rechner ohne Akku blendet sich das Feld von selbst aus." },
      { name: "🌐  Datenmengen mitgezaehlt", text: "Neben dem momentanen Datenfluss zaehlt das Programm mit, wie viel insgesamt empfangen und gesendet wurde — und schaltet die Einheit selbst von Megabyte auf Gigabyte oder Terabyte um." },
      { name: "📌  Immer obenauf, verschiebbar, einklappbar", text: "Die Leiste bleibt ueber allen Fenstern, laesst sich mit der Maus an eine andere Stelle ziehen und per Pfeil zu einem schmalen Streifen einklappen. Die Position wird gemerkt." },
      { name: "🎚️  Aufzeichnen und Anzeigen getrennt", text: "Zu jedem Bestwert gibt es zwei Schalter: ob er ueberhaupt noch aufgezeichnet wird und ob er in der Liste steht. So kann ein Wert im Hintergrund weiterlaufen, ohne die Uebersicht zu fuellen." },
      { name: "💾  Alles bleibt nach dem Neustart", text: "Gewaehlte Anzeigen, Groesse, Stromzaehler und Bestwerte liegen in drei einfachen Textdateien und ueberleben jeden Neustart. Geschrieben wird ueber eine Zwischendatei, damit ein Absturz keinen Zaehlerstand zerreisst." },
      { name: "📦  Installer mit Autostart", text: "Deutschsprachiger Einrichtungsassistent mit Startmenue-Eintrag, wahlweise Desktop-Symbol und automatischem Start beim Anmelden." },
      { name: "🗑️  Beim Deinstallieren wird gefragt", text: "Wer das Programm entfernt, wird gefragt, ob die gesammelten Bestwerte und Zaehlerstaende mit verschwinden sollen. Bei Nein bleiben sie fuer eine spaetere Neuinstallation liegen." },
      { name: "ℹ️  Ehrlich, was gemessen und was geschaetzt ist", text: "Die Prozessor-Watt sind eine Schaetzung aus der Auslastung — Windows gibt keinen echten Wert heraus. Die Grafikkarten-Watt sind dagegen gemessen. Die vier Grafikkarten-Felder brauchen eine NVIDIA-Karte und blenden sich sonst aus, die Prozessor-Temperatur erscheint nur mit Administratorrechten. Der Stromverbrauch ist die Summe aus Grafikkarte und Prozessor, nicht der Steckdosenwert des ganzen Rechners." },
    ],
    kennung: "Kapitel 04",
  ...
  yourfilm: {
    kennzahlen: [{ zahl: "3", text: "Ebenen je Film" }, { zahl: "9", text: "Traegerformate" }, { zahl: "11", text: "Editionsarten" }, { zahl: "13", text: "Sortierungen" }],
    ablaufTitel: "So fängst du an",
    ablaufSchritte: [
      ...
      { nr: "2", titel: "Treffer bestaetigen", text: "Die App sieht zuerst in der eigenen Sammlung nach und meldet Bekanntes. Nichts wird ungefragt uebernommen: Jeder Vorschlag will bestaetigt werden." },
      { nr: "3", titel: "Angaben ausfuellen", text: "In der Erfassungsmaske stehen Film, Ausgabe und das eigene Exemplar nebeneinander — Format, Edition, Kaufpreis, Zustand, alles aenderbar." },
      { nr: "4", titel: "Cover aufnehmen", text: "Das Cover per Kamera oder aus der Galerie hinzufuegen. Dieser Schritt laesst sich ueberspringen und spaeter nachholen." },
      { nr: "5", titel: "Standort waehlen", text: "Zimmer, Regal und Fach zuordnen, damit die Disc spaeter wiederzufinden ist. Auch dieser Schritt ist ueberspringbar." },
      { nr: "6", titel: "Sammlung durchsehen", text: "Die Sammlung als Raster oder Liste durchblaettern, ueber das Regal ansteuern, filtern und sortieren — und in der Statistik sehen, was zusammengekommen ist." },
    ],
    kniffTitel: "Film, Ausgabe und Exemplar bleiben getrennt",
    kniffText: "Die meisten Sammel-Apps kennen nur eine Ebene: einen Eintrag je Disc. YourFilm trennt drei. Der Film ist das Werk, die Veroeffentlichung die konkrete Ausgabe mit Format, Edition und Barcode, das Exemplar das eigene Stueck mit Kaufpreis, Zustand und Regalplatz. Dadurch bleiben Blu-ray, 4K und Steelbook desselben Films ein einziger Filmeintrag — und trotzdem laesst sich fuer jedes einzelne Stueck sagen, was es gekostet hat und wo es liegt.",
    koennenTitel: "Was drinsteckt",
    koennenListe: [
      { name: "📷  Barcode scannen", text: "Den Strichcode auf der Huelle vor die Kamera halten — die App liest ihn und legt den Film an." },
      { name: "🔢  Sechs Barcode-Arten", text: "EAN-13, EAN-8, UPC-A, UPC-E, ISBN und unbekannte Codes werden erkannt und auf ihre Pruefziffer geprueft." },
      { name: "⚠️  Dubletten melden", text: "Ist ein Barcode schon in der Sammlung, sagt die App es und laesst die Wahl: weiteres Exemplar, vorhandenen Film oeffnen oder abbrechen." },
      { name: "✍️  Von Hand erfassen", text: "Ohne Kamera und ohne Netz laesst sich jeder Film vollstaendig von Hand eintragen." },
      { name: "💿  Mehrere Ausgaben", text: "Blu-ray, 4K und Steelbook desselben Films haengen als eigene Veroeffentlichungen unter einem einzigen Filmeintrag." },
      { name: "💶  Vier getrennte Preise", text: "UVP und Marktpreis bei Erscheinen gehoeren zur Ausgabe, Kaufpreis und geschaetzter Wert zum eigenen Stueck — keiner wird aus einem anderen abgeleitet." },
      ...
      { name: "🔍  Suche ueber alles", text: "Ein Suchfeld findet ueber Titel, Originaltitel, Schauspieler, Regie, Genre, Studio und Barcode — und liefert Filme wie Personen." },
      ...
      { name: "⚡  Zehn Schnellfilter", text: "Ein Tipp genuegt fuer 4K, Blu-ray, DVD, FSK 18, Ungesehen, Favoriten, Steelbooks, Verliehen oder zuletzt Hinzugefuegtes." },
      { name: "🤝  Verleih verfolgen", text: "Wer hat die Disc, seit wann, bis wann — die App meldet, wenn die Rueckgabefrist verstrichen ist." },
      ...
      { name: "💾  Sichern und einlesen", text: "Die ganze Sammlung laesst sich als Datei sichern und wieder einspielen — die Sicherung wird vor dem Einlesen geprueft und der Bericht gezeigt." },
    ],
    bilderTitel: "Ein Blick in die App",
  ...
  zeitwissen: {
    ...
    ablaufSchritte: [
      ...
      { nr: "3", titel: "Einstempeln", text: "Auf Heute waehlst du Projekt und Aufgabe und tippst auf Einstempeln. Die Uhr laeuft sichtbar mit." },
      { nr: "4", titel: "Ausstempeln", text: "Am Feierabend ein Tipp auf Ausstempeln. Die Pause zieht die App selbst ab, Ueberschneidungen meldet sie sofort." },
    ...
    kniffText: "Jede Zahl in ZeitAnker - der Tagessaldo, die Wochenbilanz, der Verdienst, die Zahl im Bericht - kommt aus derselben Rechenklasse. Fuenfzehn Dateien fragen sie ab, aber gebaut wird sie an genau einer Stelle. Deshalb kann der Bericht am Monatsende nie etwas anderes sagen als der Bildschirm am Morgen. Bei Apps, die an mehreren Stellen nachrechnen, ist genau das die haeufigste Fehlerquelle.",
    koennenTitel: "Was drinsteckt",
    koennenListe: [
      ...
      { name: "📅  Vier Zeitraeume", text: "Tag, Woche, Monat und Jahr zeigen dieselben Zeiten in vier Zoomstufen." },
      ...
      { name: "🎯  Sollzeit frei waehlbar", text: "Die Sollzeit kommt wahlweise je Wochentag, je Woche, je Monat oder je Jahr." },
      ...
      { name: "⚠️  Ueberlappungen erkennen", text: "Zwei Eintraege zur selben Zeit meldet die App im Klartext, bevor sie gespeichert werden." },
      { name: "📝  Zwei Notizfelder", text: "Je Eintrag gibt es eine Arbeitsnotiz fuer den Kunden und eine allgemeine Notiz fuer dich." },
      { name: "🏖️  Urlaub und Krankheit", text: "Freie Tage lassen sich in vier Arten eintragen und zaehlen im Zeitkonto mit." },
  ...
  familie: {
    ...
    ablaufTitel: "So fängst du an",
    ablaufSchritte: [
      { nr: "1", titel: "Startseite oeffnen", text: "Die Familie zeigt alle zehn Apps untereinander — mit Nummer, Symbol, Zweckzeile und der Zahl ihrer Funktionen." },
      { nr: "2", titel: "App antippen und arbeiten", text: "Ein Tipp oeffnet die gewaehlte App in voller Funktion. Du schiesst eine Runde, baust einen Pfeil oder fuehrst dein Werkstattbuch — ganz normal." },
      { nr: "3", titel: "Ueber den Familien-Knopf zurueck", text: "Der Knopf unten links bringt dich zur Familie zurueck und laedt dabei die Daten neu ein." },
      { nr: "4", titel: "Analyse aufrufen", text: "Der Knopf ANALYSE oben sammelt die Kennzahlen aller Apps ein und zeigt zuerst deine Schuetzen, dann die Empfehlungen." },
      ...
      { nr: "6", titel: "Zusammenspiel nachlesen", text: "Das Netz-Symbol oben rechts zeigt die zehn Datenwege und erklaert, was zwischen welchen Apps fliesst." },
    ],
    kniffTitel: "Eine Drehscheibe, an der jede App nur andockt",
    kniffText: "Die Apps kennen einander nicht. Jede haengt sich an einen gemeinsamen Vertrag mit vier Methoden — sie liefert ihre Werte, meldet ihren Bestand, sagt welche Datenart sie annimmt und nimmt Empfehlungen entgegen. Alles andere macht die Drehscheibe in der Mitte: Sie sammelt ein, laesst bewerten, sortiert nach Dringlichkeit und gibt jede Empfehlung genau an den Bereich zurueck, der sie umsetzen kann. Deshalb bewertet der Coach auch Werte aus Wetter, Range oder Werkstattbuch mit — er ist der einzige Bewerter neben der Bandpruefung, und er sieht alles.",
    koennenTitel: "Was drinsteckt",
    koennenListe: [
      ...
      { name: "👆  Antippen, App laeuft", text: "Ein Tipp auf eine enthaltene App oeffnet die echte App mit voller Funktion, nicht eine Beschreibungsseite." },
      { name: "📊  Analyse ueber alles", text: "Eine eigene Analyse-Seite sammelt die Kennzahlen aller Apps ein und zeigt sie gemeinsam statt je App getrennt." },
      { name: "🎯  Was du tun solltest", text: "Aus allen Werten entsteht eine Empfehlungsliste, sortiert nach Dringlichkeit, jede mit Begruendung und Quelle." },
      { name: "🗂️  Deine Daten an einem Ort", text: "Die Bestandsseite zeigt alles, was die Apps gespeichert haben, gebuendelt in vier Bereichen: Schuetzen, Ausruestung, Verlauf, Sammlungen." },
      { name: "🔄  Eintraege uebernehmen", text: "Ein Eintrag laesst sich per Knopf in eine andere App holen — dort entsteht eine eigene Kopie, das Original bleibt unberuehrt." },
      ...
      { name: "🏹  Schuetzen wiedererkennen", text: "Farbe und Symbol eines Schuetzen stammen aus Instinct Scoring — derselbe Schuetze sieht in jeder App gleich aus." },
      ...
      { name: "🔎  Filtern und sortieren", text: "Die Auswertung laesst sich nach Wertungssystem und Parcours filtern und nach Schnitt, Haeufigkeit oder Punkten sortieren." },
      { name: "🕸️  Zusammenspiel ansehen", text: "Eine eigene Seite zeigt zehn Datenwege und erklaert je Weg, was von welcher App zu welcher fliesst." },
      { name: "⚖️  Zielbereiche statt Bauchgefuehl", text: "Werte werden gegen einen Zielbereich geprueft und als im Band, knapp oder ausserhalb eingestuft." },
      { name: "🔬  Belastbarkeit ausgewiesen", text: "Zu jeder Angabe steht, worauf sie beruht: gemessen, Fachliteratur oder Erfahrungswert." },
      { name: "🌗  Hell und dunkel", text: "Die Oberflaeche folgt der Systemeinstellung und stellt sich auf helle oder dunkle Darstellung ein." },
    ],
  ...
  tankspur: {
    kennzahlen: [{ zahl: "8", text: "Auswertungs-Bereiche" }, { zahl: "26", text: "Hersteller im Katalog" }, { zahl: "159", text: "Modelle offline im Geraet" }, { zahl: "11", text: "Kraftstoff-Sorten" }],
    ablaufTitel: "So fängst du an",
    ablaufSchritte: [
      { nr: "1", titel: "Anmelden", text: "Beim ersten Start ein Konto anlegen — die Daten liegen danach getrennt je Konto auf dem Geraet." },
      { nr: "2", titel: "Fahrzeug anlegen", text: "Im Reiter Auto Hersteller und Modell aus dem Katalog waehlen, Kraftstoff, Tankgroesse und optional ein eigenes Foto ergaenzen." },
      { nr: "3", titel: "Tanken eintragen", text: "Der Knopf Tanken oeffnet das Formular: entweder von Hand ausfuellen oder den Beleg fotografieren und den Vorschlag bestaetigen." },
      { nr: "4", titel: "Uebersicht ablesen", text: "Der Startreiter zeigt fuer das gewaehlte Jahr Ausgaben, Strecke, Verbrauch, Literpreis und den Vergleich zum Vorjahr." },
      { nr: "5", titel: "Statistik durchgehen", text: "Ueber die acht Bereiche Jahre, Monate, Preis, Verbrauch, Rekorde, Vergleich, Tankstellen und Muster die Diagramme durchblaettern." },
      { nr: "6", titel: "Daten mitnehmen", text: "Ueber das Teilen-Symbol die Eintraege als CSV ausgeben oder im Profil eine vorhandene CSV einlesen." },
    ],
    kniffTitel: "Der Beleg wird nachgerechnet, nicht nur abgelesen",
    kniffText: "Andere Apps uebernehmen die Zahlen vom Beleg so, wie die Texterkennung sie liest. Tankspur prueft sie gegeneinander: Liegen Literpreis und Menge vor, wird der Gesamtpreis daraus gerechnet und eine abweichend gelesene Summe verworfen. Und wenn der Beleg gar keine Beschriftung hergibt — etwa bei einer nackten Zapfsaeulen-Anzeige — sucht die App unter allen erkannten Zahlen das Tripel, bei dem Preis mal Menge den Betrag ergibt. Passt keines, bleiben die Felder leer statt falsch gefuellt.",
    koennenTitel: "Was drinsteckt",
    koennenListe: [
      ...
      { name: "🧮  Dritter Wert rechnet sich", text: "Wer zwei der drei Werte Literpreis, Menge und Gesamtpreis eintippt, bekommt den dritten von selbst ausgefuellt." },
      { name: "📷  Beleg abfotografieren", text: "Foto vom Tankbeleg per Kamera oder aus der Galerie — die Texterkennung laeuft auf dem Geraet und schlaegt Datum, Tankstelle, Menge und Preis vor." },
      { name: "🏷️  Tankstelle wird erkannt", text: "Der Beleg-Leser kennt die Schreibweisen von 24 Tankstellen-Marken und traegt den Namen selbst ein." },
      ...
      { name: "🔎  Fahrzeug aus dem Katalog", text: "Hersteller, Modell, Generation und Karosserie aus einem mitgelieferten Nachschlagewerk waehlen — oder frei eintippen." },
      { name: "📊  Sechs Fahrzeug-Karten", text: "Je Auto zeigen Karten Fahrzeugdaten, Kraftstoff, Verbrauch, Tankungen, Kilometer und Kosten." },
      { name: "🏆  Acht Rekorde", text: "Guenstigster und teuerster Literpreis, bester und hoechster Verbrauch, laengste Fahrt sowie groesste, teuerste und guenstigste Betankung." },
      { name: "📈  Preistrend und Verlauf", text: "Der Literpreis wird ueber die Zeit gezeichnet, mit gleitendem Mittel und dem guenstigsten sowie teuersten Tag." },
      { name: "🗓️  Muster im Kalender", text: "Durchschnittspreise je Monat und je Wochentag zeigen, wann Tanken guenstiger war." },
      { name: "🔮  Hochrechnung aufs Jahr", text: "Aus den bisherigen Ausgaben und dem verstrichenen Jahresanteil wird geschaetzt, worauf das laufende Jahr hinauslaeuft." },
      { name: "⚖️  Zwei Jahre vergleichen", text: "Ein eigener Bereich stellt zwei frei gewaehlte Jahre nebeneinander." },
      { name: "📥  CSV einlesen", text: "Bestehende Aufzeichnungen als CSV-Datei uebernehmen — Trennzeichen und Kopfzeile werden selbst erkannt." },
      { name: "📤  CSV weitergeben", text: "Alle Betankungen als Excel-taugliche CSV-Datei ausgeben und teilen." },
      { name: "🌍  Deutsch und Englisch", text: "Die Sprache folgt dem Geraet oder wird fest auf Deutsch beziehungsweise Englisch gestellt." },
    ],
    bilderTitel: "Ein Blick in die App",
  ...
  scheinbar: {
    ...
    ablaufTitel: "So fängst du an",
    ablaufSchritte: [
      { nr: "1", titel: "Schein aufnehmen", text: "Auf der Startseite den Knopf zum Scannen antippen, den Spielschein fotografieren oder ein Bild aus der Galerie waehlen." },
      { nr: "2", titel: "Zahlen pruefen", text: "In der Korrektur-Maske stehen die erkannten Tippfelder, die Losnummer und die angekreuzten Zusatzspiele - alles laesst sich vor dem Speichern anpassen." },
      { nr: "3", titel: "Zeitraum setzen", text: "Teilnahmezeitraum und - beim Lotto - die Superzahl eintragen, dann speichern." },
      { nr: "4", titel: "Ziehungen holen", text: "In den Einstellungen die Ziehungsliste nachladen - oder bei BINGO! im Live-Modus waehrend der Sendung selbst mittippen." },
      { nr: "5", titel: "Gewinn ablesen", text: "Der Schein zeigt je Ziehung im Zeitraum die Treffer und die Gewinnklasse, dazu eine eigene Karte fuer die Zusatzspiele." },
      { nr: "6", titel: "Zahlen auswerten", text: "Im Statistik-Bereich zwischen Gezogen, Meine Zahlen und Gewinne umschalten und das gewuenschte Zeitfenster waehlen." },
    ],
    kniffTitel: "Drei Lotterien, ein Regelwerk - und eine einzige Rechenstelle",
    kniffText: "BINGO!, Lotto 6aus49 und Eurojackpot funktionieren voellig verschieden: 22 aus 75 gegen eine positionsechte 25er-Karte, 6 aus 49 mit Superzahl, 5 aus 50 mit zwei Eurozahlen. ScheinBar haelt Zahlbereiche und Sollmengen aller drei an genau einer Stelle und rechnet Gewinne an genau einer weiteren - dieselbe Pruefung erkennt volle BINGO!-Reihen, Lotto-Klassen und Eurojackpot-Klassen. Deshalb gilt beim BINGO! auch die Spaltenregel: eine Zahl muss dort stehen, wo sie hingehoert, sonst meldet die App es schon beim Erfassen. Und weil Gewinne immer frisch gerechnet und nie gespeichert werden, stimmt jeder Schein sofort, sobald eine neue Ziehung dazukommt.",
    koennenTitel: "Was drinsteckt",
    koennenListe: [
      { name: "📷  Schein abfotografieren", text: "Der Spielschein wird mit der Kamera aufgenommen oder aus der Galerie geholt, die Texterkennung laeuft direkt auf dem Geraet." },
      ...
      { name: "🅱️  BINGO!-Reihen zaehlen", text: "Bei BINGO! zaehlt die App die vollen Reihen der 25er-Karte - fuenf waagerecht, fuenf senkrecht und zwei diagonal." },
      { name: "🔴  Live mitspielen", text: "Waehrend der BINGO!-Ziehung werden die Zahlen im B-I-N-G-O-Raster angetippt, die Treffer erscheinen sofort und die Ziehung laesst sich ab 22 Zahlen speichern." },
      { name: "🎫  Zusatzspiele mitpruefen", text: "Spiel 77, SUPER 6 und die BINGO!-Superchance werden aus Losnummer, Serie und Los mitgerechnet." },
      { name: "📚  Ziehungsarchiv", text: "Alle Ziehungen der drei Lotterien liegen nach Spiel getrennt zum Nachschlagen bereit." },
      { name: "🔄  Ziehungen nachladen", text: "Die gepflegte Ziehungsliste laesst sich per Tipp nachladen; ergaenzt wird nur, was fehlt - Vorhandenes bleibt unberuehrt." },
      { name: "📊  Drei Auswertungen", text: "Die Statistik zeigt Gezogen (Haeufigkeiten und ueberfaellige Zahlen), Meine Zahlen (gespielt gegen gezogen) und Gewinne." },
      { name: "⏳  Zeitfenster waehlen", text: "Jede Auswertung laesst sich auf 30 Tage, 3, 6 oder 12 Monate eingrenzen - oder auf alles." },
      { name: "🩶  Kuerzlich Gezogenes", text: "Zahlen aus den letzten fuenf Ziehungen werden grau hinterlegt - beim Erfassen wie in der Ansicht, und per Augen-Symbol abschaltbar." },
      { name: "🎨  Aussehen einstellen", text: "Hell, dunkel oder wie das System - dazu neun Farben fuer die Treffer-Markierung." },
      { name: "💾  Daten sichern", text: "Scheine, Tippfelder und Ziehungen lassen sich als Datei sichern und spaeter wieder einspielen, ohne Vorhandenes zu ueberschreiben." },
    ],
    bereicheTitel: "Die Bereiche",

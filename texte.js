...
de: {
  ...
  campus: {
    ...
    bilderText: "Fünf Bilder aus einem laufenden Spielstand.",
    bilder: [
      { bild: "campus-1-campus", titel: "Dein Campus", text: "Oben Gesundheit, Energie und Geld, dazu der Weg in die nächste Klasse. Darunter die Favoriten mit dem, was gerade läuft — auch wenn das Handy in der Tasche steckt." },
      { bild: "campus-2-schule", titel: "Der Schulalltag", text: "Lernen, Jobs und Duell an einer Stelle, dazu die eigene Allianz und die schulweiten Verbesserungen." },
      { bild: "campus-3-lernen", titel: "64 Fächer", text: "Jedes Fach mit Dauer, Level und was es bringt. Drei laufen gleichzeitig — in echter Zeit, auch wenn die App zu ist." },
      { bild: "campus-4-schulhof", titel: "Der Schulhof", text: "Mitschüler zum Anfreunden oder Herausfordern. Wer zu dir gehört, zahlt jeden Tag Taschengeld." },
      { bild: "campus-5-markt", titel: "Der Flohmarkt", text: "47 Gegenstände in fünf Seltenheitsstufen, darunter steht, was du gerade trägst. Das Angebot wechselt dreimal am Tag — oder sofort, gegen Gebühr." },
    ],
  ...
  yourfilm: {
    ...
    bilderTitel: "Ein Blick in die App",
    bilderText: "Fünf Aufnahmen aus der laufenden Fassung. Die Sammlung darin ist ein Beispiel.",
    bilder: [
      ...
      { bild: "yourfilm-4-statistik", titel: "Was die Sammlung sagt", text: "Genres, Altersfreigaben, Jahrzehnte und Gesamtlaufzeit — gerechnet aus dem, was wirklich im Regal steht." },
      { bild: "yourfilm-5-mehr", titel: "Zimmer, Regal, Fach", text: "Jedes Exemplar bekommt seinen Platz. Die Regalübersicht zeigt mit Cover-Streifen, was wo steht." },
    ],
    bereicheTitel: "Die Bereiche",
  ...
  zeitwissen: {
    ...
    bilder: [
      ...
      { bild: "zeitanker-2-zeitraum", titel: "Tag, Woche, Monat, Jahr", text: "Vier Zoomstufen auf dieselben Zeiten. Gearbeitet, Soll und Differenz stehen oben, darunter jeder Tag mit seinem eigenen Saldo." },
      { bild: "zeitanker-3-projekte", titel: "Projekte und Aufgaben", text: "Zeiten lassen sich unter Projekten bündeln — je Projekt eigene Aufgaben, eigene Farbe und ein eigener Satz. Ohne Premium sind es drei Projekte." },
      { bild: "zeitanker-4-mehr", titel: "Zeitkonto und Bericht", text: "Hier liegen Zeitkonto, Sollzeit und Pausen sowie der Bericht — mit Premium als Excel, PDF oder HTML zum Weitergeben." },
      { bild: "zeitanker-5-premium", titel: "Was Premium öffnet", text: "Bericht, Verdienst, Jahresübersicht, Urlaub und beliebig viele Projekte; auf Android dazu das Startbildschirm-Widget. Das Erfassen selbst bleibt immer kostenlos — 4,99 € im Jahr oder 0,49 € für vier Wochen, Kündigung und Abo-Angaben stehen auf derselben Seite." },
    ],
    bereicheTitel: "Die Bereiche",
  ...
  scheinbar: {
    ...
    bilder: [
      { bild: "scheinbar-1-start", titel: "Der Einstieg", text: "Scannen, von Hand eingeben oder BINGO! live — darunter die aktiven Scheine, unten die vier Bereiche." },
      ...
      { bild: "scheinbar-3-schein", titel: "Dein Schein", text: "Teilnahmezeitraum, Superzahl und die getippten Zahlen — darunter jede Ziehung mit Treffern und Gewinnklasse." },
      ...
      { bild: "scheinbar-5-statistik", titel: "Was die Zahlen sagen", text: "Häufigste Zahlen mit Zähler — umschaltbar auf eigene Zahlen und Gewinne, je Zeitraum und Ziehungstag." },
    ],
...
en: {
  ...
  campus: {
    ...
    bilderText: "Five shots from a save that is well under way.",
    bilder: [
      { bild: "campus-1-campus", titel: "Your campus", text: "Health, energy and money on top, plus the way into the next grade. Below that your favourites with whatever is running right now — even with the phone in your pocket." },
      { bild: "campus-2-schule", titel: "School life", text: "Study, jobs and duels in one place, plus your own alliance and the school-wide upgrades." },
      ...
      { bild: "campus-4-schulhof", titel: "The schoolyard", text: "Classmates to befriend or challenge. Whoever belongs to you pays pocket money every day." },
      { bild: "campus-5-markt", titel: "The flea market", text: "47 items across five rarity tiers, with what you are wearing right below. Stock changes three times a day — or instantly, for a fee." },
    ],
  ...
  yourfilm: {
    ...
    bilderTitel: "A look inside",
    bilderText: "Five shots from the running build. The collection in them is a sample.",
    bilder: [
      ...
      { bild: "yourfilm-4-statistik", titel: "What the collection says", text: "Genres, age ratings, decades and total runtime — computed from what is actually on the shelf." },
      { bild: "yourfilm-5-mehr", titel: "Room, shelf, compartment", text: "Every copy gets its place. The shelf overview shows what sits where, with cover strips." },
    ],
    bereicheTitel: "The areas",
  ...
  zeitwissen: {
    ...
    bilder: [
      ...
      { bild: "zeitanker-2-zeitraum", titel: "Day, week, month, year", text: "Four zoom levels on the same hours. Worked, target and difference sit at the top, with every day and its own balance below." },
      { bild: "zeitanker-3-projekte", titel: "Projects and tasks", text: "Hours group under projects — each with its own tasks, its own colour and its own rate. Without premium you get three projects." },
      { bild: "zeitanker-4-mehr", titel: "Balance and reports", text: "Balance, target hours and breaks and the report live here — with premium as Excel, PDF or HTML, ready to hand over." },
      { bild: "zeitanker-5-premium", titel: "What premium opens", text: "Reports, earnings, the yearly overview, leave days and unlimited projects; on Android a home-screen widget as well. Tracking itself always stays free — €4.99 a year or €0.49 for four weeks, with cancellation and the subscription terms on the same page." },
    ],
    bereicheTitel: "The areas",
  ...
  scheinbar: {
    ...
    bilder: [
      { bild: "scheinbar-1-start", titel: "The starting point", text: "Scan, type it in, or BINGO! live — your active tickets below, and the four areas at the bottom." },
      ...
      { bild: "scheinbar-3-schein", titel: "Your ticket", text: "Entry period, bonus ball and your numbers — below them every draw with its hits and prize tier." },
      ...
      { bild: "scheinbar-5-statistik", titel: "What the numbers say", text: "The most frequent numbers with their count — switchable to your own numbers and wins, per period and draw day." },
    ],
